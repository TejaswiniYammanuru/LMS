  ...
  return (
    <div className='pb-14 px-8 md:px-0'>
      ...
      <div className='flex items-center m-20'>
        ...
        <div key={index} className='m-7 text-sm text-left border border-gray-500/30 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden'>
